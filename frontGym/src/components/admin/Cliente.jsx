...
export const Cliente = ({ cliente: c }) => {
    ...
    Swal.fire({
      ...
      html: ` <table>
			...
			'DD MMMM YYYY'
			  ...
			  <tr><b>Finanzas:</b> ${c.estado_financiero ? 'Al dia <i class="fas fa-check"></i>' : 'Atrasado <i class="fas fa-times-circle"></i>'}</tr><br>
  ...
  const handleMsg = async () => {
    const { value: formValues } = await Swal.fire({
      ...
      html: '<input placeholder="Asunto" id="swal-input1" class="swal2-input">' + '<textarea placeholder="Escribe tu mensaje" id="swal-input2" class="swal2-input">',
      focusConfirm: false,
